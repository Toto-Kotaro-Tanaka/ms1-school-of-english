...
* **[W3C CSS Validation Service](https://jigsaw.w3.org/css-validator/)** was used to check any errors on css file. I confirm that there were no errors which were same as Pre-Testing. However, there were 8 warnings appeared. **[Warning (8)](https://stackoverflow.com/questions/25946111/importing-css-is-ending-up-with-an-error)** is just information that it's not going to validate the imported style sheet. **[The rest of warnings](https://stackoverflow.com/questions/3468154/what-is-webkit-and-how-is-it-related-to-css)** were related to webKit which is a HTML/CSS web browser rendering engine for Safari/Chrome and they were added on my CSS after putting it in Autoprefixer so these warnings could be ignored
